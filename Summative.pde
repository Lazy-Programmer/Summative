...
void setup() {
 ...
 // walls.add(new Wall(new PVector(500, 100 ), new PVector(800, 10), 0, "asd"));
  //LoadMap("floor");
  //myPlayer.addAnimation("MainCharacterWalk.anim");
  //myPlayer.addAnimation("MainCharacterShootingStanding.anim");
  //myPlayer.addAnimation("MainCharacterShootingWalking.anim");
  //dummy.addAnimation("BirbWalking.anim");
  noStroke();
